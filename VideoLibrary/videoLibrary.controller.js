...
const getVideoLibraryByUserId = async (req, res, next) => {
  const {userId} = req
...
const checkPlaylistId = async (req, res, next) => {
...
const getVideoLibrary = async (req, res) => {
  ...
  try {
    ...
    console.log(error)
    res.status(500).json({ success: false, message: "Unable to retrive the Video Library" })
  }
}
...
module.exports = { getVideoLibrary, getVideoLibraryByUserId, updateVideoLibrary, deleteVideoFromVideoLibrary, checkPlaylistId, getPlaylist, updatePlaylist, deleteVideoFromPlaylist }